  ...
  return (
    <div style={{minHeight:"100vh",background:"linear-gradient(135deg, #0a0a0a 0%, #1a1a2e 50%, #0a0a0a 100%)",fontFamily:"'Inter',-apple-system,BlinkMacSystemFont,sans-serif",color:"#fff"}}>
      ...
      <nav style={{position:"fixed",top:0,left:0,right:0,zIndex:100,background:"rgba(10,10,10,0.95)",backdropFilter:"blur(10px)",borderBottom:"1px solid #D4AF3722",padding:"0.5rem 1rem",display:"flex",alignItems:"center",gap:"0.5rem",overflowX:"auto"}}>
        ...
        <div style={{display:"flex",gap:"0.25rem",alignItems:"center"}}>
          <a href="https://central-portal-yums-projects-e09fdaf7.vercel.app" style={{padding:"0.4rem 0.75rem",borderRadius:"6px",textDecoration:"none",fontSize:"0.8rem",fontWeight:600,display:"flex",alignItems:"center",gap:"0.3rem",color:"#999"}}>🏠 Portal</a>
            ...
            <a href="https://centillion-stream-yums-projects-e09fdaf7.vercel.app" style={{padding:"0.4rem 0.75rem",borderRadius:"6px",textDecoration:"none",fontSize:"0.8rem",fontWeight:600,display:"flex",alignItems:"center",gap:"0.3rem",background:"#D4AF37",color:"#000"}}>📺 Stream</a>
      ...
      <div style={{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",minHeight:"100vh",padding:"5rem 2rem 2rem",textAlign:"center"}}>
        ...
        <h1 style={{fontSize:"clamp(2rem,5vw,3.5rem)",fontWeight:800,background:"linear-gradient(135deg, #D4AF37, #fff, #D4AF37)",WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",marginBottom:"0.5rem",letterSpacing:"-0.02em"}}>Centillion Stream</h1>
        <p style={{fontSize:"1.25rem",color:"#D4AF37",fontWeight:600,marginBottom:"1rem",letterSpacing:"0.1em",textTransform:"uppercase"}}>Live. On Demand. Unlimited.</p>
        <p style={{fontSize:"1.1rem",color:"#888",maxWidth:"500px",lineHeight:1.6,marginBottom:"2rem"}}>Premium streaming platform for video content, live events, and exclusive drops.</p>
